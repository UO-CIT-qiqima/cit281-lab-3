...
// getCarMakeModel(). The arrow function MUST NOT use a return statement (use implicit return)
// Include a console.log statement similar to getCarMakeModel,
// but increment the number from 0 to 1.

let getCarMakeModelImplicit = (car) => getCarMakeModel(car);
...
let getCarMakeModelDestructure = (car) => {
